...
import pe.edu.vallegrande.ms_distribution.application.services.UserService;
import pe.edu.vallegrande.ms_distribution.domain.enums.Constants;
import pe.edu.vallegrande.ms_distribution.domain.models.User;
import pe.edu.vallegrande.ms_distribution.infrastructure.dto.request.UserCreateRequest;
import pe.edu.vallegrande.ms_distribution.infrastructure.dto.response.UserResponse;
import pe.edu.vallegrande.ms_distribution.infrastructure.exception.CustomException;
import pe.edu.vallegrande.ms_distribution.infrastructure.repository.UserRepository;
...
public class UserServiceImpl implements UserService {
                    ...
                    .flatMap(exists -> {
                         ...
                         return userRepository.save(user)
                                   .map(savedUser -> {
                                        ...
                                        response.setResponsibleUserId(savedUser.getResponsibleUserId());
     ...
     @Override
     public Mono<User> desactivate(String id) {
